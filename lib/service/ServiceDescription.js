...
class ServiceDescription {
    ...
    getMethodsDescriptions() {
        ...
        log.debug("Got Method Descriptions: '%o'", methods);
    ...
    static getPackageNameOfService(serviceName) {
        ...
        serviceChunks.pop();
        log.debug("Got Package Name: '%s'", serviceChunks.join('.'));
    ...
    static getBaseServiceName(serviceName) {
        let serviceChunks = serviceName.split('.');
        log.debug("Got Base Service Name: '%s'", serviceChunks[serviceChunks.length - 1]);
